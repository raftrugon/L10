...
public class SubscriptionServiceTest extends AbstractTest {
	...
	protected void templateFindOne(int suscriptionId, Class<?> expected, String explanation) {

		Class<?> caught = null;

		try {
			subscriptionService.findOne(suscriptionId);
		...
		System.out.println("NewpspaperId: " + suscriptionId);
	...
	public void driverCreate(){
		...
		Object testingData[][] = {
				//Test positivo
				{
					"user1", null, "Creación correcta de una suscripción"
				},
		};
