...
public class SystemConfigServiceTest extends AbstractTest {
	...
	public void driverFindOne() {
		...
		System.out.println("===============================================================================================================");
		System.out.println("=====================================TEST FIND ONE SYSTEM CONFIG==================================================");
		System.out.println("===============================================================================================================\r");

		Object testingData[][] = {
			//Positive test
			{
				getEntityId("systemConfig1"), null, "Búsqueda del find One correcto"
			},
	...
	protected void templateFindOne(int systemConfigId, Class<?> expected, String explanation) {

		Class<?> caught = null;

		try {
			systemConfigService.findOne(systemConfigId);
		...
		System.out.println("SystemConfigId: " + systemConfigId);
